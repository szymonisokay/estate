import { Checkbox, Col, Divider, Input, InputNumber, Row, Select, Space, Typography } from 'antd'
import React from 'react'
import { parkingType, propertyType, StepsComponentInterface } from '../../../config/steps.config'

const AdditionalInformation: React.FC<StepsComponentInterface> = ({ offer, updateOffer }) => {
	return (
		<>
			<Input.Group>
				<Row gutter={[20, 20]}>
					...
					<Col xs={{ span: 24 }} md={{ span: 12 }}>
						<Space direction='vertical' style={{ width: '100%', rowGap: '2px' }}>
							<Typography.Text type='secondary'>Construction year*</Typography.Text>
							<Input
								style={{ width: '100%' }}
